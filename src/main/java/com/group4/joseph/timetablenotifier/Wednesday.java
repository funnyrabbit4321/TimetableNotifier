...
public class Wednesday extends AppCompatActivity implements View.OnClickListener{

    DBHandler dbHandlerWednesday;

    Button toThursdayButton;
    Button toTuesdayButton;
    Button submitWednesdayButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toThursdayButton = (Button)findViewById(R.id.forwardButton);
        toThursdayButton.setOnClickListener(Wednesday.this);
        toTuesdayButton = (Button)findViewById(R.id.backbutton);
        toTuesdayButton.setOnClickListener(Wednesday.this);
        //submitWednesdayButton = (Button)findViewById(R.id.submitFridayButton);
        //submitWednesdayButton.setOnClickListener(Wednesday.this);
        mainMenuButton = (Button)findViewById(R.id.mainMenuButton);
        mainMenuButton.setOnClickListener(Wednesday.this);
        settingsButton = (Button)findViewById(R.id.settingsButton);
        settingsButton.setOnClickListener(Wednesday.this);
       ...
       /* modInput9 = (EditText) findViewById(R.id.modInput9);
        ...
        dbHandlerWednesday = new DBHandler(this, null, null, 1);

        //Toast.makeText(Wednesday.this, "Press SUBMIT to save the timetable", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v){
        switch(v.getId()){
            case R.id.forwardButton:
                final Intent thursday_intent = new Intent(this, Thursday.class);
            ...
            /*case R.id.deleteDBButton:
                dbHandlerWednesday.deleteModuleTuesday();     //delete the table
    ...
    public void printToEditText() {
        Cursor c = dbHandlerWednesday.readAllWednesday();
        String str = "@";
        int length = 0;
        int position = -1;
    ...
    public void saveDataWednesday(){
        Calendar calendar = Calendar.getInstance();
        int day = calendar.get(Calendar.DAY_OF_WEEK);
        dbHandlerWednesday.deleteModuleWednesday();     //Delete the DB just before it gets updated again, this allows us to update it
        Spinner spinner = (Spinner) findViewById(R.id.modInput9);
        Spinner spinner2 = (Spinner) findViewById(R.id.locInput9);
        ...
        dbHandlerWednesday.addModuleWednesday(module_location_9, 9, spinner_pos9, spinner2_pos9);         //NEED TO ADD ALL LOCATIONS TO THE DB
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_10, 10, spinner_pos10, spinner2_pos10);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_11, 11, spinner_pos11, spinner2_pos11);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_12, 12, spinner_pos12, spinner2_pos12);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_1, 13, spinner_pos1, spinner2_pos1);       //Use 13 (13:00) for time from 1-5pm
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_2, 14, spinner_pos2, spinner2_pos2);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_3, 15, spinner_pos3, spinner2_pos3);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_4, 16, spinner_pos4, spinner2_pos4);
        if (day == Calendar.WEDNESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerWednesday.addModuleWednesday(module_location_5, 17, spinner_pos5, spinner2_pos5);
        if (day == Calendar.WEDNESDAY) {
