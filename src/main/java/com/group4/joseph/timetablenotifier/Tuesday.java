...
public class Tuesday extends AppCompatActivity implements View.OnClickListener{

    DBHandler dbHandlerTuesday;

    Button toWednesdayButton;
    Button toMondayButton;
    Button submitTuesdayButton, deleteTuesdayButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toWednesdayButton = (Button)findViewById(R.id.forwardButton);
        toWednesdayButton.setOnClickListener(Tuesday.this);
        toMondayButton = (Button)findViewById(R.id.backbutton);
        toMondayButton.setOnClickListener(Tuesday.this);
        //submitTuesdayButton = (Button)findViewById(R.id.submitFridayButton);
        //submitTuesdayButton.setOnClickListener(Tuesday.this);
        mainMenuButton = (Button)findViewById(R.id.mainMenuButton);
        mainMenuButton.setOnClickListener(Tuesday.this);

        settingsButton = (Button)findViewById(R.id.settingsButton);
        settingsButton.setOnClickListener(Tuesday.this);
        //deleteTuesdayButton = (Button)findViewById(R.id.deleteTuesdayButton);
        //deleteTuesdayButton.setOnClickListener(Tuesday.this);
        ...
        dbHandlerTuesday = new DBHandler(this, null, null, 1);

        //Toast.makeText(Tuesday.this, "Press SUBMIT to save the timetable", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v){
        switch(v.getId()){
            ...
            case R.id.backbutton:
                //submitTimetable();
                final Intent monday_intent = new Intent(this, Monday.class);
            ...
            //Toast.makeText(Tuesday.this,"SAVED DATA", Toast.LENGTH_LONG).show();
            //break;

            /*case R.id.deleteDBButton:
                dbHandlerTuesday.deleteModuleTuesday();     //delete the table
                Toast.makeText(Tuesday.this,"DELETED TUESDAY TABLE", Toast.LENGTH_LONG).show();
                break;*/
        }
    }

    public void saveDataTuesday() {
        Calendar calendar = Calendar.getInstance();
        int day = calendar.get(Calendar.DAY_OF_WEEK);
        dbHandlerTuesday.deleteModuleTuesday();     //Delete the DB just before it gets updated again, this allows us to update it
        Spinner spinner = (Spinner) findViewById(R.id.modInput9);
        Spinner spinner2 = (Spinner) findViewById(R.id.locInput9);
        ...
        dbHandlerTuesday.addModuleTuesday(module_location_9, 9, spinner_pos9, spinner2_pos9);         //NEED TO ADD ALL LOCATIONS TO THE DB
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_10, 10, spinner_pos10, spinner2_pos10);
        if (day == Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_11, 11, spinner_pos11, spinner2_pos11);
        if (day==Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_12, 12, spinner_pos12, spinner2_pos12);
        if (day==Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_1, 13, spinner_pos1, spinner2_pos1);       //Use 13 (13:00) for time from 1-5pm
        if (day == Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_2, 14, spinner_pos2, spinner2_pos2);
        if (day == Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_3, 15, spinner_pos3, spinner2_pos3);
        if (day == Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_4, 16, spinner_pos4, spinner2_pos4);
        if (day == Calendar.TUESDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerTuesday.addModuleTuesday(module_location_5, 17, spinner_pos5, spinner2_pos5);
        if (day == Calendar.TUESDAY) {
            callNotification(14, 50, 0, module5, location5);
        }
    }
    ...
    public void printToEditText(){
        Cursor c = dbHandlerTuesday.readAllTuesday();
        String str = "@";
        int length = 0;
        int position = -1;
