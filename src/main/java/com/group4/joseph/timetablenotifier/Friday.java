...
public class Friday extends AppCompatActivity implements View.OnClickListener{

    DBHandler dbHandlerFriday;

    Button toMondayButton;
    Button toThursdayButton;
    Button submitFridayButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toThursdayButton = (Button)findViewById(R.id.backbutton);
        toThursdayButton.setOnClickListener(Friday.this);
        toMondayButton = (Button)findViewById(R.id.forwardButton);
        toMondayButton.setOnClickListener(Friday.this);
        //submitFridayButton = (Button) findViewById(R.id.submitFridayButton);
        //submitFridayButton.setOnClickListener(Friday.this);
        mainMenuButton = (Button)findViewById(R.id.mainMenuButton);
        mainMenuButton.setOnClickListener(Friday.this);
        settingsButton = (Button)findViewById(R.id.settingsButton);
        settingsButton.setOnClickListener(Friday.this);
        ...
        dbHandlerFriday = new DBHandler(this, null, null, 1);

        //Toast.makeText(Friday.this, "Press SUBMIT to save the timetable", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v){
        switch(v.getId()){
            ...
            //    Toast.makeText(Friday.this,"SAVED DATA", Toast.LENGTH_LONG).show();
            //    break;
    ...
    public void printToEditText() {
        Cursor c = dbHandlerFriday.readAllFriday();
        String str = "@";
        int length = 0;
        int position = -1;
    ...
    public void saveDataFriday(){
        Calendar calendar = Calendar.getInstance();
        int day = calendar.get(Calendar.DAY_OF_WEEK);
        dbHandlerFriday.deleteModuleFriday();     //Delete the DB just before it gets updated again, this allows us to update it
        Spinner spinner = (Spinner) findViewById(R.id.modInput9);
        Spinner spinner2 = (Spinner) findViewById(R.id.locInput9);
        ...
        dbHandlerFriday.addModuleFriday(module_location_9, 9, spinner_pos9, spinner2_pos9);         //NEED TO ADD ALL LOCATIONS TO THE DB
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_10, 10, spinner_pos10, spinner2_pos10);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_11, 11, spinner_pos11, spinner2_pos11);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_12, 12, spinner_pos12, spinner2_pos12);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_1, 13, spinner_pos1, spinner2_pos1);       //Use 13 (13:00) for time from 1-5pm
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_2, 14, spinner_pos2, spinner2_pos2);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_3, 15, spinner_pos3, spinner2_pos3);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_4, 16, spinner_pos4, spinner2_pos4);
        if (day == Calendar.FRIDAY) {
        ...
        //dbHandler.deleteRow( module_location_9);
        dbHandlerFriday.addModuleFriday(module_location_5, 17, spinner_pos5, spinner2_pos5);
        if (day == Calendar.FRIDAY) {
